        ...
        <div class="order-confirmed-container">
            ...
            <% 
                ...
                if (ticketId != null && !ticketId.isEmpty()) {
                    ...
                    errorMessage = "Missing Ticket ID parameter.";
                }
            %>
            ...
            <div class="payment-details">
                ...
                <p><strong>Price (per ticket):</strong> Rp <%= orderDetails.get("price") %></p>
            ...
            <% } else { %>
                <p style="color: red;">Error displaying order details: <%= errorMessage %></p>
